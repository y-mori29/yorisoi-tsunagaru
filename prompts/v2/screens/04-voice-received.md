...
## 3. Hero illustration (top, ~360px tall)
- A small horizontal illustration centered on cream background
- Content: **a small folded cream letter resting on a wooden table**,
  with a single sprig of dried sage/lavender beside it, and a thin
  moss-green silk ribbon trailing to the right edge.
- Style: editorial illustration (Kinfolk aesthetic), warm muted tones
- Padding: 24px from sides
- Optional very faint warm light from upper-left

## 4. Eyebrow text (below illustration)
- "**ある となりさんから**" in Yu Gothic 11px, sepia (#7E5A40),
  letter-spacing wide
- Centered
...
- Bottom-left small detail: a tiny **turtle line-icon avatar** inside a
  cream circle (28px), with "**あるとなりさん**" in 12px gray (#7A7068)
...
- Cluttered metadata (only the timer and "あるとなりさん" are shown)
