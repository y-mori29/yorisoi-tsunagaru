...
- Layout: small bird line-icon (60px) inside cream circle on the left,
  ...
  - Sub: "**今朝までに、そっと**" Yu Gothic 12px, #7A7068
...
**意図**: 通知を「煩わしいもの」でなく「お便り」として再定義。色分けは控えめだが、種類別に微妙な背景色で識別できるようにする。
