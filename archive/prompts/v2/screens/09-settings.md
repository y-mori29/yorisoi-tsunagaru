...
- Row 2: small flower icon in moss circle + "**案内（性格・暮らしのリズム）**"
  + sub "**お隣さがしを、より近づけるために**" + chevron-right

## 7. Section label "**お便り**"
## 8. Notification list (~120px)
Two rows:
- Row 1: bell icon in plum circle + "**お便りを受け取る**" + sub
  "**そっと届く声・反応・お隣さん**" + a **toggle switch on the right** (ON, terra-500)
...
Three rows:
- Row 1: lock icon + "**声のデフォルト公開**" + sub "**みんな / お隣さんだけ / しずか**"
...
- Row 3: shield icon in plum + "**ブロックしている お隣さん**" + sub
  "**今 2 人**" + chevron-right
