---
title: お隣さがし（性格マッチ） — 完成スクリーンショット風モックアップ
...
A high-fidelity iOS mockup of the "**お隣さがし**" (find similar people)
...
- Center: "**お隣さがし**" Yu Gothic Medium 17px
- Right: empty
...
- Divider label: "**あなたのお隣さん候補**" Yu Gothic Medium 14px (#2A2622),
